...
function ActiveShiftSummary(): React.ReactNode {
  ...
  return (
    ...
    >
      {activeShift ? (
        <div className="w-full flex flex-row gap-2 h-full py-1">
          <div className="py-2 px-3 w-1/3 rounded-xl bg-emerald-50/[0.8] dark:bg-emerald-950/20 dark:border-emerald-500/[0.2] border border-emerald-200 flex items-center gap-2.5">
          ...
          <div className="py-2 px-3 w-1/3 rounded-xl bg-blue-50/[0.8] dark:bg-blue-950/20 dark:border-blue-500/[0.2] border border-blue-200 flex items-center gap-2.5">
          ...
          <div className="py-2 px-3 w-1/3 rounded-xl bg-amber-50/[0.8] dark:bg-amber-950/20 dark:border-amber-500/[0.2] border border-amber-200 flex items-center gap-2.5">
        ...
        <div className="flex flex-row items-center justify-between w-full rounded-xl bg-red-50/[0.8] p-3 dark:bg-red-950/20 dark:border-red-500/[0.2] border border-red-200 gap-3">
