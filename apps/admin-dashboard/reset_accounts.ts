  ...
  try {
    ...
    await adminDb.collection("hotels").doc("1").collection("users_master").doc(demoDocId).set({
      ...
      permissions: {
        ...
        module_food_beverage: true, module_purchasing: true, module_accounting: true, module_cpanel: true, module_hrd: true,
        overview: true, "digital-checkin": true, forecast: true, "inventory-control": true, invoice: true,
        pnl: true, "pnl-budget": true, dsr: true, budgeting: true, statements: true,
        logo: true, hero: true, "room-type": true, about: true, gallery: true, footer: true, attractions: true,
        promo: true, packages: true, seo: true, users: true, hrd: true, purchasing: true,
        ...
        "food-beverage-product": true, "food-beverage-realtime": true,
